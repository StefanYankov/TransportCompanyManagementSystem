...
public abstract class TransportCargoVehicleUpdateDto extends VehicleUpdateDto {
    ...
    public TransportCargoVehicleUpdateDto(Long id, String registrationPlate, Long colourId, Long transportCompanyId, Double maxCargoCapacityKg, Double currentCargoCapacityKg, CargoType cargoType) {
