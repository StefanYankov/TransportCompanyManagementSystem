...
public class BusUpdateDto extends TransportPeopleVehicleUpdateDto {
    ...
    public BusUpdateDto(Long id, String registrationPlate, Long colourId, Long transportCompanyId, Integer maxPassengerCapacity, Boolean hasRestroom, BigDecimal luggageCapacity) {
